...
export const pcParts = [
  ...
  { id: 'mobo1', category: 'Motherboard', name: 'ASUS ROG Strix B650E-F', price: 259.99, specs: 'AM5 Socket, ATX, PCIe 5.0' },
  { id: 'mobo2', category: 'Motherboard', name: 'MSI MAG Z790 Tomahawk', price: 239.99, specs: 'LGA 1700 Socket, ATX, DDR5' },
  { id: 'ram1', category: 'RAM', name: 'Corsair Vengeance RGB 32GB', price: 119.99, specs: 'DDR5-6000, CL30, 2x16GB' },
  { id: 'ram2', category: 'RAM', name: 'G.Skill Trident Z5 Neo 64GB', price: 214.99, specs: 'DDR5-6000, CL30, 2x32GB' },
  ...
  { id: 'case1', category: 'Case', name: 'Fractal Design North', price: 139.99, specs: 'Mid Tower, ATX, Wood Front Panel' },
  { id: 'case2', category: 'Case', name: 'Lian Li O11 Dynamic EVO', price: 159.99, specs: 'Mid Tower, ATX, Dual Chamber' }
];
